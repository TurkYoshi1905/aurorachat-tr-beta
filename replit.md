...
**v0.7.5** — Çift DM bildirim sorunu giderildi, DM geçmişi hesap izolasyonu (IndexedDB kullanıcı ID'ye göre), silinen konuşma yeni mesajda otomatik geri geliyor, DM Supabase Realtime eklendi, Windows/macOS bildirimi düzeltildi, welcome/leave trigger v6 yeniden yapılandırıldı.
