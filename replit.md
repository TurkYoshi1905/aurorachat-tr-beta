...
**v0.7.2** — Hoşgeldin mesajı çift gönderim ve {user} şablon hatası düzeltildi (SQL trigger çakışması giderildi, frontend kodu kaldırıldı), yetkili rol atanınca sunucu ayarları butonu gerçek zamanlı görünüyor (fetchPerms useCallback'e alındı).
