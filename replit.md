...
**v0.6.1** — Electron ESM modül hatası düzeltme, gradient animasyon iyileştirmesi, sunucu ban kontrolü, davet embed üye sayısı düzeltmesi, gerçek zamanlı sunucu listesi güncellemesi, DM mesaj scroll navigasyonu.
