...
const VoiceJoin = () => {
  ...
  const [room]          = useState(() => new Room({ adaptiveStream: true, dynacast: true, audioCaptureDefaults: { echoCancellation: true, noiseSuppression: true, autoGainControl: true } }));
  ...
  const toggleCamera = async () => {
    ...
    else { await startCamera(facingMode); }
  };
