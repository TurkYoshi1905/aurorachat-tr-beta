...
const Rules = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Hero */}
      <div className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-red-500/10 via-orange-500/5 to-transparent">
        <div className="absolute -top-32 -right-24 w-96 h-96 rounded-full bg-red-500/15 blur-3xl pointer-events-none" />
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 pt-8 pb-12">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-red-400 via-foreground to-orange-400">
                AuroraChat Kuralları
              </h1>
