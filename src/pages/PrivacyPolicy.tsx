  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(ellipse 80% 60% at 80% 0%, hsl(var(--primary) / 0.18), transparent 60%), radial-gradient(ellipse 70% 50% at 0% 100%, hsl(var(--accent) / 0.12), transparent 60%), linear-gradient(135deg, hsl(var(--primary) / 0.07), hsl(var(--primary) / 0.03) 50%, transparent 100%)',
        }}
      >
          ...
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-2xl sm:text-4xl font-bold tracking-tight text-foreground">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-foreground to-accent">{t('privacy.title')}</span>
              </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        {/* Quick highlights */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6 sm:mb-10">
          {[
