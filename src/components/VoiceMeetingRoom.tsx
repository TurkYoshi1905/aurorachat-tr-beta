...
const ScreenShareView = ({ sharerIdentity, room }: { sharerIdentity: string; room: Room | null }) => {
  ...
  useEffect(() => {
    // Never attach local participant's own screen share track — causes infinite mirror loop
...
const VoiceMeetingRoom = ({ voiceState, onToggleChat, showChat, isMobile = false, serverId }: VoiceMeetingRoomProps) => {
  ...
  const {
    ...
    voiceChannelName, voiceChannelId, toggleMic, toggleDeafen, toggleCamera, toggleScreenShare, toggleSystemAudio, disconnect,
  } = voiceState;
  ...
  }, [micMuted, deafened, remoteConnected]);
        ...
        >
          ...
          >
            ...
            <p className="text-xs text-white/40 text-center -mt-1">
              ...
              <span className="text-white/60 font-medium">mikrofon ve sesi</span> kontrol et
            </p>
