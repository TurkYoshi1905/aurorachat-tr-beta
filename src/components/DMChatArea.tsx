          ...
          <div className="flex items-center gap-2">
            <Popover open={plusMenuOpen} onOpenChange={setPlusMenuOpen}>
              <PopoverTrigger asChild>
                <button className="text-muted-foreground hover:text-foreground transition-colors shrink-0 p-1" disabled={dmBlocked}>
              ...
              <PopoverContent side="top" align="start" className="w-48 p-1.5 bg-popover border-border">
                ...
                <div className="w-full">
                  <GifPicker onGifSelect={(url) => { handleSend(url); setPlusMenuOpen(false); }}>
