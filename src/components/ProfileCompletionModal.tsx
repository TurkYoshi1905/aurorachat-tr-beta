...
import { Cake, User2, ChevronRight, Sparkles } from 'lucide-react';
    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[9999] flex items-start sm:items-center justify-center p-4 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))] bg-black/70 backdrop-blur-sm overflow-y-auto"
        >
          <motion.div
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    {step === 'gender' ? 'Devam etmek için cinsiyet seçimi gerekli' : 'Devam etmek için doğum tarihi gerekli'}
                  </p>
                </div>
              </div>
