  ...
  return (
    <UserProfileCard key={member.id} userId={member.id} serverId={serverId} status={member.status}>
      ...
      >
        ...
        {isOwner ? (
          <div className="flex-shrink-0 flex items-center gap-1 px-1.5 py-0.5 rounded text-[9px] font-bold uppercase border opacity-80 group-hover:opacity-100 transition-opacity"
            style={{ color: '#facc15', borderColor: '#facc1540', backgroundColor: '#facc1515' }}
          >
