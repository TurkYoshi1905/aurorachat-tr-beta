...
export const changelogData: ChangelogRelease[] = [
  {
    version: '1.0.4',
    date: '28 Nisan 2026',
    summary: 'Performans, izinler ve yeni "Kurallar" sayfası odaklı sürüm: mesaj render Discord seviyesine optimize edildi, tüm rol izinleri tam aktif, role renk değişiklikleri anlık yansıyor, giriş ekranı için özel ban modali, kelime filtresi muaf roller arama çubuğu ve modern Kurallar sayfası eklendi.',
    sections: [
      {
  ...
  },
  {
    version: '1.0.3',
    date: '27 Nisan 2026',
    summary: 'Kapsamlı kararlılık ve özellik sürümü: kayıt hatası giderildi, gerçek zamanlı roller ve bildiri durumları düzeltildi, beklenmedik çıkış sorunu sağlamlaştırıldı; e-posta doğrulama modali, profesyonel ban modali, mesaj silme onayı ve Tauri masaüstü bildirimleri eklendi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '1.0.2',
    date: '26 Nisan 2026',
    summary: 'Windows masaüstü uygulaması (Tauri) yayınlandı — EXE kurulum dosyası ile tek tıkla kurulum, otomatik güncelleme desteği, bağlı cihazlarda şehir/ülke konumu.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '1.0.1',
    date: '25 Nisan 2026',
    summary: 'Rol üye yönetimi güçlendirildi, mesajlar Discord gibi gruplanıyor, boşluklu kullanıcı adlarında etiket sorunu giderildi ve Android APK v1.0.1 doğrudan GitHub\'dan indirilebilir hale getirildi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '1.0.0',
    date: '24 Nisan 2026',
    summary: '🎉 AuroraChat 1.0! Kayıtta cinsiyet ve doğum tarihini dolduran kullanıcılar artık girişte "Profilini Tamamla" modalını görmüyor: kayıt tetikleyicisi bu alanları doğrudan auth metadata\'sından profile yazıyor ve mevcut tüm hesaplar için otomatik backfill çalıştı.',
    sections: [
      {
        title: 'Düzeltmeler',
        icon: Bug,
  ...
  },
  {
    version: '0.9.10',
    date: '24 Nisan 2026',
    summary: 'Gizlilik kartlarındaki "Mevcut" değer artık doğru görünüyor (cinsiyet ve doğum tarihi profilden okunuyor) ve kayıt akışının sonunda gelişmiş "E-posta Gönderildi" modalı açılıyor — sağlayıcıya özel hızlı erişim, adım adım yönergeler ve geri sayımlı tekrar gönderme bilgisi ile.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.9',
    date: '23 Nisan 2026',
    summary: 'Cinsiyet ve doğum tarihi değişiklik modaları yeniden tasarlandı (haftalık limit göstergesi, animasyonlar, daha açıklayıcı uyarılar) ve davet bağlantılarına "karşılama kanalı" seçici eklendi — sunucu sahibi yeni katılımcıların doğrudan hangi kanala düşeceğini belirleyebilir.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.8',
    date: '23 Nisan 2026',
    summary: 'Üye listesi sadeleştirildi, profil kartına sahip taç rozeti eklendi, sunucu emojileri ile tepki, mobil uygulama indirme, gizlilikte cinsiyet/doğum tarihi değiştirme (haftada 2 limit) ve raporlarda gerçek zamanlı durum düzeltmesi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.7',
    date: '21 Nisan 2026',
    summary: '"Yayını İzle" butonu artık paylaşan kişinin karesinin üzerinde, hoş geldin/güle güle mesajlarındaki üye sayısı düzeltildi, link önizlemeleri zenginleştirildi (YouTube, OG resim ve açıklama).',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.6',
    date: '21 Nisan 2026',
    summary: 'Discord tarzı "Yayını İzle" akışı, ekran paylaşımı için tam ekran ve yatay mod, arka plan bulanıklığı kaldırıldı, mobilde otomatik kanal çıkışı iyileştirildi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.5',
    date: '20 Nisan 2026',
    summary: 'Mobil kamera çevirme özelliği, mesaj arama tam ekran düzeltmesi, Bildirilerim gerçek zamanlı durum güncellemesi, DM okunmamış nokta düzeltmesi ve ses odası ghost session temizliği.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.4',
    date: '19 Nisan 2026',
    summary: 'Güvenlik güçlendirmesi, yeni UI modalları ve WebRTC düzeltmeleri: mesaj sabitleme yetkisi veritabanı seviyesinde kısıtlandı, kullanıcı adı benzersizliği garanti altına alındı, profesyonel emoji ve kullanıcı adı modalları eklendi, ses/ekran sorunları giderildi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.3',
    date: '19 Nisan 2026',
    summary: 'Mobil ses akışı ve izin yönetimi düzeltildi, sağırlaştırma/mikrofon durumları gerçek LiveKit state ile eşitlendi, ekran paylaşımı siyah alan sorunu azaltıldı, profil tamamlama zorunlu hale getirildi ve kelime filtresine rol muafiyeti eklendi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.2',
    date: '18 Nisan 2026',
    summary: 'Davet linki URL düzeltildi, moderasyon kullanıcı listesi tek sütuna getirildi, e-posta doğrulama PKCE akışı düzeltildi, çevrimiçi kullanıcı sayacı üyeler için de çalışır hale getirildi, DM okunmamış göstergesi eklendi ve "Bildirilerim" sekme eklendi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.1',
    date: '18 Nisan 2026',
    summary: 'Mesaj gönderim gecikmesi azaltıldı, moderasyon sayfasında canlı durum çevrimdışı görünme hatası giderildi, yeni kayıt profil tamamlama penceresi düzeltildi, DM yeniden kayıt sorunu çözüldü ve silinen kullanıcı mesajları korunur hale getirildi.',
    sections: [
      {
        title: 'İyileştirmeler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.9.0',
    date: '17 Nisan 2026',
    summary: 'Moderasyon kullanıcı arama hatası düzeltildi, kullanıcılar A-Z listeleniyor, canlı durum göstergeleri eklendi ve kurucu için sebep yazmalı hesap ban/ban kaldırma sistemi getirildi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.8.9',
    date: '17 Nisan 2026',
    summary: 'Kayıt sihirbazına cinsiyet seçimi ve kullanım koşulları adımı, ilk kez giren kullanıcılar için karşılama sayfası, gizlilik politikası güncellemesi, profil kartında cinsiyet/doğum tarihi görünürlük ayarları, moderasyon paneli iyileştirmeleri ve şifre güvenlik göstergesi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.8.8',
    date: '16 Nisan 2026',
    summary: 'AuroraChat Moderasyon Paneli (gerçek zamanlı bildirim yönetimi, kullanıcı arama, admin yetkilendirme), mesaj bildirme sistemi (kırmızı bayrak butonu + modal), Premium Kullanıcı Ayarlarına RGB animasyon ve v0.8.8 sürüm notları.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.8.7',
    date: '14 Nisan 2026',
    summary: 'Davet kartı canlı üye sayacı, mobil ses uzaktan kontrolüne kamera düğmesi, yetkili mesaj silme realtime senkronizasyonu, welcome/leave mesaj değişkenleri, optimize ses yakalama ayarları ve gelişmiş denetim kaydı filtreleri.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
  ...
  },
  {
    version: '0.8.6',
    date: '13 Nisan 2026',
    summary: 'Spotify entegrasyonu (şu an çalan gösterimi, 403/429 akıllı backoff), video oynatıcı tam yeniden tasarımı, emoji sekmesi grid görünümü ve arama, gradyan renk seçici debounce düzeltmesi ve gradyan metin repaint düzeltmesi.',
    sections: [
      {
        title: 'Yeni Özellikler',
        icon: Sparkles,
